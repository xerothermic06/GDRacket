...
public:
	...
	bool _has_static_method(const StringName &method) const;
    ...
    bool is_placeholder_fallback_enabled() { return true; }
...
// RacketModule ////////////////////////////////////////////////////////////////
// Represents an arbitrary .rkt file that will not be imported as a Script. This
// is meant to support "library" Racket files containing multiple class
// definitions or utility code that can then be require'd from .gd.rkt scripts.
// May want to rethink this architecture if it becomes a nuiscance.
class RacketModule : public Resource {
    GDCLASS(RacketModule, Resource)
